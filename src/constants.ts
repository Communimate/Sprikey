...
if (isNullish(process.env.STAFF_APPLICATION_CHANNEL_ID)) throw new Error("Staff Application Channel ID not found!");
...
if (isNullish(process.env.STAFF_ELIGIBILITY_ROLE_ID)) throw new Error("Staff Eligibility Role ID not found!");
...
export const STAFF_APPLICATION_CHANNEL_ID = process.env.STAFF_APPLICATION_CHANNEL_ID;
export const STAFF_ELIGIBILITY_ROLE_ID = process.env.STAFF_ELIGIBILITY_ROLE_ID;

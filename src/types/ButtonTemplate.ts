import type { ButtonBuilder, InteractionResponse, Message } from "discord.js";
...
export interface ButtonTemplate<ButtonName extends string = string, AllowedInDMs extends boolean = boolean> {
  ...
  run(bot: SprikeyBot, context: DiscordButtonContext<AllowedInDMs>): Promise<InteractionResponse | Message | void>;
}
